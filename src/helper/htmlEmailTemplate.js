                                                                                                                            ...
                                                                                                                            <div>
                                                                                                                                <div
                                                                                                                                    ...
                                                                                                                                    <span
                                                                                                                                        ...
                                                                                                                                        You can click below to reset your password
                                                                                                                                        </span>
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td align="center"
                                                                                                                            ...
                                                                                                                            <table
                                                                                                                                ...
                                                                                                                                style="text-align:center; cursor: pointer; margin-bottom:30px">
                                                                                                                                <tbody>
                                                                                                                                    <tr>
                                                                                                                                        <td align="center"
                                                                                                                                            bgcolor="#ffbe00"
                                                                                                                                            class="inner-td"
                                                                                                                                            style="margin-bottom:10px; border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                                                                                                                                    

                                                                                                                                                <a href="mailto:${TECH_SUPPORT_EMAIL}"
                                                                            ...
                                                                            <div data-role="module-unsubscribe"
                                                                                ...
                                                                                <div class="Unsubscribe--addressLine">
                                                                                    ...
                                                                                    <p
                                                                                        style="font-size:12px; line-height:20px;">
                                                                                        <span
                                                                                            class="Unsubscribe--senderAddress">KN
                                                                                            7 Ave</span>, <span
                                                                                            class="Unsubscribe--senderCity">Kigali</span>,
                                                                                        <span
                                                                                            class="Unsubscribe--senderState">Rwanda</span>
                                                                                        <span
                                                                                            class="Unsubscribe--senderZip">.</span>
                                                                                    </p>
                                                                                </div>
                                                                                <p
                                                                                    style="font-size:12px; line-height:20px;">
